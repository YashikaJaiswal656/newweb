        ...
        <div className="metrics-column">
          <div className="performance-card">
            ...
            <div className="card-description">
              <p>
                                                Finike Lithium batteries offer superior power and efficiency, ensuring seamless performance for telecom applications. Embrace sustainable energy for a greener future.</p>
            </div>
          </div>
        </div>
        ...
        <div className="range-column">
          <div className="range-card">
            ...
            <div className="vehicle-showcase">
              <img src="https://finikelithium.com/static/media/telecomimage.16edfd792d28533ef465.jpeg" alt="Electric Vehicle" />
            </div>
          </div>
        </div>
