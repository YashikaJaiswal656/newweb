  ...
  return (
    <div className="battery-performance-hub">
      ...
      <div className="title-banner">
        <h1 className="main-title">Why Choose Our Batteries?</h1>
        <div className="title-underline">
          <div className="underline-segment segment-orange"></div>
          <div className="underline-dot"></div>
          <div className="underline-segment segment-blue"></div>
        </div>
        <p className="banner-subtitle">Engineered for excellence, designed for the future of electric mobility</p>
      </div>
        ...
        <div className="metrics-column">
          <div className="performance-card">
            ...
            <div className="card-description">
              <p>Our lithium-ion EV batteries offer <span className="text-highlight-blue">high-performance</span> energy solutions with superior efficiency and an extended lifespan. <span className="text-highlight-orange">Designed for OEMs, dealers, and enthusiasts,</span> our batteries are driving the future of sustainable transportation.</p>
            </div>
          </div>
        </div>
        ...
        <div className="range-column">
          <div className="range-card">
            ...
            <div className="vehicle-showcase">
              <img src="https://finikelithium.com/static/media/twowheeler.139385b79b35e2ad50ac.JPG" alt="Electric Vehicle" />
            </div>
          </div>
        </div>
